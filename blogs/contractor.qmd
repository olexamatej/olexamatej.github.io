...
This analysis focuses on stack vulnerabilities. For an example of heap exploitation from the same CTF, see the companion post on [Tcache Poisoning via Off-by-One in the 'Strategist' challenge](link-to-strategist-post.md). 
